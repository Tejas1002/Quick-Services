...
class YogaFitnessController extends Controller
{
    public function index()
    {
        $category = Category::where('name', 'Yoga')->firstOrFail();
        ...
        return view('pages.yoga-fitness', compact('products', 'totalProducts', 'category', 'savedItemsCount'));
    }
